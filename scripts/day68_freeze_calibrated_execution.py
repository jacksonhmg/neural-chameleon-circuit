#!/usr/bin/env python3
"""Freeze replacement-study thresholds after calibration and before final access."""
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError("inherited calibration provenance differs")
    ...
    contract = {
        "schema_version": 1,
        "procedure": "day68-calibrated-locked-title-closure-execution-v1",
        "status": "frozen_after_replacement_generation_and_calibration_before_any_locked_final_outcome",
        "program_sha256": program_hash,
        "generated_contract_sha256": sha256_file(GENERATED_CONTRACT_PATH),
